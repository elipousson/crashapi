...
* Added functions for accessing FARS APIs including Get Crash List Information, Get Crashes By Location, Get Summary Counts, and Get FARS Data By Year (documented in `get_fars()`)
